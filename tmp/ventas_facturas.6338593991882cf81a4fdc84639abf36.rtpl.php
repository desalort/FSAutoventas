   ...
   <table class="table table-hover">
      ...
      <tr class="clickableRow<?php if( $value1->vencida() OR $value1->anulada ){ ?> danger<?php }elseif( $value1->pagada ){ ?> success<?php }elseif( $value1->total<=0 ){ ?> warning<?php } ?>" href="<?php echo $value1->url();?>">
         <td class="text-center">
            ...
            <span class="glyphicon glyphicon-send" title="La <?php  echo FS_FACTURA;?> fue enviada por email el <?php echo $value1->femail;?>"></span>
            <?php } ?>
         ...
         <td class="text-right" title="<?php echo $value1->hora;?>">
