...
<script type="text/javascript">
   ...
   $(document).ready(function() {
      <?php if( $fsc->importar_url ){ ?>

         setTimeout("location.href = '<?php echo $fsc->importar_url;?>';", 2000);
      <?php }elseif( !$fsc->listado ){ ?>
   ...
   <div class="container-fluid" style="margin-top: 10px; margin-bottom: 10px;">
      <div class="row">
         <div class="col-xs-7">
            ...
            <?php if( $fsc->asiento_apertura_url OR $fsc->asiento_cierre_url OR $fsc->asiento_pyg_url ){ ?>
